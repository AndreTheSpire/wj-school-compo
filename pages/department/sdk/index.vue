<template>
<PartsHeaderCarousel :headerimg="headerimg" logo="/img/icon/logo-sdk-glow.png"></PartsHeaderCarousel>

<PartsDepartmentNavigation :navigations="navigations" :navigatepage="navigatepage"></PartsDepartmentNavigation>
...
import { ProfileStore } from '../stores/profilestore'
    export default {
        data: () => ({
          blocktext:"SDK Wijana adalah lembaga pendidikan dasar dengan sejarah 60 tahun lebih mendidik anak-anak Jombang menjadi kader Gereja dan masyarakat.",
